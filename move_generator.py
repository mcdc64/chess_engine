...
def move_string(board,old_position,new_position,en_passant = False,promote_choice = PieceType.EMPTY):
    ...
    if(promote_choice != PieceType.EMPTY):
        ...
        if(promote_choice ==PieceType.KNIGHT):
            move_str += "=N"
    next_board = board.hypo_move(old_position,new_position,promote_choice)
...
def append_move_string(board,next_move_string):
